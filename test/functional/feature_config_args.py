...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(conf_base_path, 'a', encoding='utf-8') as conf:
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=['Ignoring unknown configuration value regtest.dash_conf']):
            self.start_node(0)
        self.stop_node(0)
